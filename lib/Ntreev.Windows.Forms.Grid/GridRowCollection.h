...
namespace Ntreev { namespace Windows { namespace Forms { namespace Grid
{
	...
	/// 열의 컬렉션을 나타냅니다.
	/// </summary>
	[System::ComponentModel::EditorAttribute("Ntreev.Windows.Forms.Grid.Design.RowCollectionEditor, Ntreev.Windows.Forms.Grid.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=7a9d7c7c4ba5dfca", System::Drawing::Design::UITypeEditor::typeid)]
	[System::ComponentModel::Design::Serialization::DesignerSerializer("Ntreev.Windows.Forms.Grid.Design.RowCollectionCodeDomSerializer, Ntreev.Windows.Forms.Grid.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=7a9d7c7c4ba5dfca", "System.ComponentModel.Design.Serialization.CodeDomSerializer")]
	...
	public: // methods
		...
		/// <summary>
		/// <see cref="InsertionRow"/>의 값을 이용하여 새로운 열의 인스턴스를 생성하고 컬렉션에 추가합니다.
		/// </summary>
		/// <returns>
		/// 새로 생성된 <see cref="Row"/>의 인스턴스입니다.
		/// </returns>
		...
		/// </summary>
		/// <remarks>
		/// 사용자는 <see cref="Row"/>형태의 인스턴스를 새로 생성해 추가 하거나, <see cref="Remove"/>등의 의해 컬렉션에서 제거된 열을 다시 추가할 수 있습니다.
		/// </remarks>
		...
		/// </exception>
		/// <exception cref="System::ArgumentException">
		/// 이미 제거가 된 경우 또는 제거할 수 없는 특수한 열일 경우
		/// </exception>
		...
		/// </summary>
		/// <remarks>
		/// 사용자는 <see cref="Row"/>형태의 인스턴스를 새로 생성해 삽입 하거나, <see cref="Remove"/>등의 의해 컬렉션에서 제거된 열을 다시 삽입할 수 있습니다.
		/// </remarks>
		/// <exception cref="System::ArgumentNullException">
		/// 매개변수 item의 값이 null일때
		/// </exception>
		/// <exception cref="System::ArgumentException">
		/// 삽입할 열이 이미 존재하거나, 같은 이름을 가진 열이 컬렉션에 이미 존재하는 경우
		/// </exception>
	...
	private: // methods
		...
		/// <summary>
		/// 특정 <see cref="System::Array"/> 인덱스부터 시작하여 열의 목록을 <see cref="System::Array"/>에 복사합니다.
        /// </summary>
		/// <param name="array">
		/// 열의 목록을 복사할 대상인 1차원 <see cref="System::Array"/>입니다. <see cref="System::Array"/>에는 0부터 시작하는 인덱스가 있어야 합니다.
		/// </param>
		...
		/// </exception>
		/// <exception cref="System::ArgumentException">
		/// array가 다차원 배열인 경우- 또는 - index가 array의 길이보다 크거나 같은 경우- 또는 - 열의 목록의 갯수가
